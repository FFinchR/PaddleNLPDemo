...
class UieClsService(WebService):

    def get_pipeline_response(self, read_op):
        return UieClsOp(name="uie_cls", input_ops=[read_op])


if __name__ == "__main__":
    ocr_service = UieClsService(name="uie_cls")
    ocr_service.prepare_pipeline_config("uie_cls_config.yml")
